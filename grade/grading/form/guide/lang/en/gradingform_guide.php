...
$string['err_suma100'] = 'La suma de porcentajes debe sumar 100';
$string['err_nopercentatge'] = 'Criterion percentatge can not be empty';
$string['err_percentatgenotnumeric']='Criterion percentatge must be numeric and lower than 100';
...
$string['percentatge'] = 'Percentatge';
